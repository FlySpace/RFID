...
struct rt_uart_ops
{
	...
	rt_size_t (*dma_transmit)(struct rt_serial_device *serial, const char *buf,
			rt_size_t size);
};

void serial_ringbuffer_init(struct serial_ringbuffer *rbuffer);
void serial_ringbuffer_putc(struct serial_ringbuffer *rbuffer, char ch);
int serial_ringbuffer_putchar(struct serial_ringbuffer *rbuffer, char ch);
int serial_ringbuffer_getc(struct serial_ringbuffer *rbuffer);
rt_uint32_t serial_ringbuffer_size(struct serial_ringbuffer *rbuffer);

...
#define UART2_RX_BUFFER_SIZE_BIT_COUNT 10
#define UART3_TX_BUFFER_SIZE_BIT_COUNT 9
#define UART3_RX_BUFFER_SIZE_BIT_COUNT 7
...
#define UART3_TX_BUFFER_SIZE ((unsigned int)1 << UART3_TX_BUFFER_SIZE_BIT_COUNT)
#define UART3_RX_BUFFER_SIZE ((unsigned int)1 << UART3_RX_BUFFER_SIZE_BIT_COUNT)
